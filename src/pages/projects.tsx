...
const Article = ({ img, title, date, link, time }: ArticleProps) => {
  return (
    <motion.li
      initial={{ y: 200 }}
      ...
      style={{
        ...
        backgroundColor: 'var(--tw-bg-light, #fff)',
        color: 'var(--tw-text-dark, #000)',
        border: '1px solid var(--tw-border-dark, #000)',
...
const Project = ({ title, type, img, link, tools, date, github }: ProjectProps) => {
  return (
    <article
